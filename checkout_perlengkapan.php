...
include 'perlengkapan/function_check.php';
...
<table class="table ">
		...
		<tr class="cross1">
			...
			<td class="t-data">
				<div class="col-lg-4">
					<input type="text" step="any" min="0" name="stok" id="stok" class="form-control" value="1">
				</div>
			</td>
		</tr>
</table>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="total" placeholder="Harga Produk" value="<?= $data['harga']; ?>" name="harga" readonly>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Nama Lengkap" name="nama">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="exampleInputPassword1">Kode Pos</label>
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Kode Pos" name="pos">
				</div>
			</div>
		</div>
