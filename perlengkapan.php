                        ...
                        ?>
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="about_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>"><?= $data["namabarang"] ?></a></h6>							
										</div>
										<div class="mid-2">
											<p ><label>$7.00</label><em class="item_price">Rp. <?=$data["harga"]?></em></p>
											<div class="block">
											...
											<div class="add">
											<a href="checkout_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>"  class="btn btn-danger my-cart-b" name="simpan" onclick="return confirm('Apakah Ingin Checkout ?');">Order Produk</a>
										</div>
									</div>
								</div>
							</div>
