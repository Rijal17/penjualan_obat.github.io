...
<div id="picture-frame">
			<img src="admin/img/<?=$data["foto"]?>" data-src="admin/img/<?=$data["foto"]?>" alt="admin/img/<?=$data["foto"]?>" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<div class="pr-single">
					<p class="reduced "><del>$10.00</del>Rp. <?= $data['harga'] ?></p>
				</div>
				...
				<p class="in-pa"> There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
					<div class="add add-3">
						<button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?= $data["id_barang"] ?>" data-name="<?= $data["namabarang"] ?>" data-summary="summary 24" data-price="<?=$data["harga"]?>" data-quantity="1" data-image="admin/img/<?=$data["foto"]?>">Add to Cart</button>
						<a href="checkout_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>"  class="btn btn-danger my-cart-b" name="simpan" onclick="return confirm('Apakah Ingin Checkout ?');">Checkout</a>
					</div>
			<div class="clearfix"> </div>
			</div>
			</div>
