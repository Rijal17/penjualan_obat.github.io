							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<div class="mid-1">
										...
										<div class="add">
											<a href="checkout_obat.php?id_barang=<?= $data['id_barang'] ?>" class="btn btn-danger my-cart-b" name="simpan" onclick="return confirm('Apakah Ingin Checkout ?');">Order Produk</a>
										</div>
									</div>
								</div>
							</div>
