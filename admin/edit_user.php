        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Update Data Produk</h1>
                    <div class="row">
                                        ...
                                        <thead>
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control" value="<?= $data['password'] ?>" placeholder="Password ...">
                                                </div>
                                                ...
                                                <a href="user.php" class="btn btn-primary mt-3 ">Kembali</a>
                                            </form>
                                        </thead>
                                </table>
                            </div>
