                                    ...
                                    <thead>
                                        ...
                                        <tr align="center">
                                            ...
                                            <td>
                                                <div class="card mb 1">
                                                    <div class="card-header">
                                                        <a href="edit_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>" class="btn btn-primary">Ubah</a>
                                                        <a href="hapus_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>" class="btn btn-primary" onclick="return confirm('Apakah Ingin Menghapus Data ? ');">Hapus</a>
                                                    </div>
                                            </td>
                                        </tr>
                                        <?php $a++; ?>
        ...
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="text" name="namabarang" placeholder="Masukan Nama Produk" class="form-control" require>
                    <br>
