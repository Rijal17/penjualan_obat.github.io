...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <div class="card">
        <ul class="list-group">
            <li class="list-group-item">ID Pembelian : <?= $data['id'] ?><b></b></li>
            <li class="list-group-item">Nama Pelanggan : <?= $data['nama'] ?></li>
            <li class="list-group-item">Nama Barang : <?= $data['namabarang'] ?></li>
            <li class="list-group-item">Total Pembayaran : <?= $data['harga'] ?></li>
            <li class="list-group-item">Alamat : <?= $data['alamat'] ?></li>
            <li class="list-group-item">Kota : <?= $data['kota'] ?></li>
            <li class="list-group-item">No Telp : <?= $data['telp'] ?></li>
        </ul>
    <br>
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group">
                ...
                <div class="form-group">
                    <select id="surat" class="form-control" name="status" disabled>
                        <option value="surat"><?= $data['status'] ?></option>
                    </select>
                </div>
            </div>
