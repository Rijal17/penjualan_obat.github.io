			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
						...
						<li class=""><a href="#tab2" data-toggle="tab">Perlengkapan Medis</a></li>  
					...
					<div class="tab-pane active text-style" id="tab1">
						...
						<?php
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">	
									<div class="offer-img">						
										<img src="admin/img/<?=$data["foto"]?>" class="img-responsive" alt="">
									</div>

									<div class="mid-1">
										<div class="women">
											<h6><a href="about_obat.php?id_barang=<?= $data['id_barang'] ?>"><?= $data["namabarang"] ?></a></h6>							
										</div>
										...
										<div class="add">
											<div class="btn-success my-cart-b">
												<a href="checkout_obat.php?id_barang=<?= $data['id_barang'] ?>" style="text-decoration: none;" name="simpan" onclick="return confirm('Apakah Ingin Checkout ?');">Order Produk</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="tab-pane  text-style" id="tab2">
						<div class=" con-w3l">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<div class="offer-img">
										<img src="admin/img/<?=$data["foto"]?>" class="img-responsive" alt="eror">
									</div>
									...
									<div class="mid-1">
										...
										<div class="add">
											...
											<a style="text-decoration: none; color:green;" href="checkout_perlengkapan.php?id_barang=<?= $data['id_barang'] ?>" name="simpan" onclick="return confirm('Apakah Ingin Checkout ?');">Order Produk</a>
											</div>
										</div>
