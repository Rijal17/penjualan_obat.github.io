...
<div class="container" style="padding-bottom: 300px;">
	<h4 class="text-center" style="font-weight: bold;">Terima kasih Sudah Berbelanja di Bibit Store, Pesananmu sedang diproses silahkan tunggu barangmu dirumah ya.. :)</h4>
	<div class="row" style=" margin-left: 25%; margin-top: 30px;">
        <div class="col-md-8 text-center">
            <div class="alert alert-info">
            <p>Silahkan Melakukan Pembayaran Ke
            <br>
            <strong>BANK BRI 4987-01-016362-53-7 AN Syamsul Rijal Asri</strong> <br>
            Dan Konfirmasi Jika Pembayaran Selesai Ke Nomor 082293204972 <br>
            Setelah Itu Pembayaran Akan Dikonfirmasi Oleh Admin
            </p>
			<br>
			<strong>Klik Tombol Dibawah ini</strong>
			<br>
			<a href="https://wa.me/6285156536398" class="btn btn-primary btn-submit">Konfirmasi</a>
            </div>
        </div>
    </div>
</div>
